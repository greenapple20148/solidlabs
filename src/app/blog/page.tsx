    ...
    <div className="pt-32 pb-24 bg-[#020817] min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-16">
           ...
           <div className="relative w-full md:w-72">
              ...
              <input 
                ...
                className="w-full bg-white/5 border border-white/10 rounded-lg py-2.5 pl-10 pr-4 text-sm text-white focus:outline-none focus:border-blue-500 transition-all"
              />
           </div>
        </div>
        ...
        <motion.div
          ...
          className="relative rounded-3xl overflow-hidden border border-white/5 bg-gradient-to-br from-blue-600/10 to-transparent p-8 lg:p-16 mb-16 group cursor-pointer"
        >
           <div className="absolute top-0 right-0 p-8">
              <ArrowUpRight className="w-8 h-8 text-white/20 group-hover:text-blue-400 transition-all group-hover:translate-x-1 group-hover:-translate-y-1" />
           </div>
           <div className="max-w-2xl relative z-10">
              <div className="flex items-center gap-3 mb-6">
                 ...
                 <span className="text-white/30 text-sm">May 20, 2024</span>
              </div>
              ...
              <div className="flex items-center gap-4">
                 <div className="w-10 h-10 rounded-full bg-blue-500/10 flex items-center justify-center border border-white/5">
                    <User className="w-5 h-5 text-blue-400" />
                 </div>
                 <div>
                    <div className="text-white font-bold text-sm">SolidLabs Solutions Team</div>
                    <div className="text-white/30 text-xs">Technical Strategy</div>
                 </div>
              </div>
           </div>
           {/* Decorative visual */}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
           {posts.map((post, i) => (
             <motion.article
               ...
               className="glass rounded-2xl border border-white/5 p-6 flex flex-col group cursor-pointer hover:border-blue-500/20 transition-all"
             >
                <div className="flex justify-between items-start mb-6">
                   <span className="text-xs font-bold uppercase tracking-widest text-blue-400">{post.tag}</span>
                   <ArrowUpRight className="w-4 h-4 text-white/20 group-hover:text-blue-400 transition-all" />
                </div>
                <h3 className="text-xl font-bold text-white mb-4 group-hover:text-blue-100 transition-colors">{post.title}</h3>
                <p className="text-white/40 text-sm leading-relaxed mb-8 flex-grow">{post.excerpt}</p>
        ...
        <div className="mt-24 rounded-3xl border border-white/5 bg-white/[0.01] p-12 text-center">
           <h2 className="text-2xl font-bold text-white mb-4">Stay at the Cutting Edge</h2>
           <p className="text-white/50 mb-8 max-w-xl mx-auto">Subscribe to our monthly technical digest for insights on AI, cloud architecture, and enterprise engineering.</p>
           <div className="flex flex-col sm:flex-row justify-center gap-4 max-w-md mx-auto">
              <input 
                type="email" 
                placeholder="your@email.com" 
                className="flex-grow bg-white/5 border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white focus:outline-none focus:border-blue-500 transition-all"
              />
