...
import { Send, Calendar, Mail, Building2, CheckCircle, Phone } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="mb-8 p-8 rounded-3xl border border-border bg-card shadow-sm"
            >
              <h3 className="text-2xl font-bold text-foreground mb-1">Solid Labs LLC</h3>
              <p className="text-xl text-muted-foreground">(307) 219-4328</p>
            </motion.div>
